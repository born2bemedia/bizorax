                ...
                <div className="article-hero__container _container">
                    <div className="article-hero__body">
                        <motion.div
                            ...
                            variants={fadeInUp}
                            custom={0.1}
                            className="article-hero__image _article-02">
                        ...
                        <div className="article-hero__content">
                            <motion.h1
                                ...
                                Top 5 Digital Tools to Streamline Business <br /> Operations
                            </motion.h1>
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                                ...
                                In today’s fast-paced business environment, efficiency is key to staying competitive. With digital tools, businesses can optimise workflows, enhance collaboration, and improve decision-making. Whether you’re a startup or a large enterprise, the right tools can make all the difference. Here’s a look at the top five digital tools to help streamline your business operations.
                            </motion.div>
                        </div>
                    </div>
                </div>
